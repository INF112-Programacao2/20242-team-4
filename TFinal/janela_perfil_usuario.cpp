...
{
    adiciona_edicao = new janela_adiciona_edicao();

    adiciona_edicao->setUserId(_user_id);

    //tranforma a janela em outra janela
    connect(adiciona_edicao, &janela_adiciona_edicao::voltarPerfil, this, &QMainWindow::show);

    //abre a janela
    adiciona_edicao->show();
